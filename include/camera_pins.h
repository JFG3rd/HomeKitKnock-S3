...
// XIAO ESP32-S3 Sense default pin map.
...
#define MOTOR
// DRV8833 doesn't need enable pin, so don't define it
// #define Motor_EN_Pin -1  // Removing this as -1 is causing an invalid pin error
// DRV8833 motor driver pinout as per Camera NanoTank project
#define MotorR_A_Pin 1 // IN1 - D0 (GPIO1)
#define MotorR_B_Pin 2 // IN2 - D1 (GPIO2)
#define MotorL_A_Pin 4 // IN3 - D3 (GPIO4)
#define MotorL_B_Pin 5 // IN4 - D4 (GPIO5)
