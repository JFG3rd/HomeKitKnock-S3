...
# Wiring Diagram (Required Wiring Only)
...
- **GPIO5 (D4)** <- INMP441 **SD/DOUT** (ESP32 RX)
...
- INMP441 **must not** be connected to GPIO12. On the Seeed XIAO ESP32-S3 Sense,
  GPIO12 = OV2640 camera Y7 data output. The camera chip drives this pin even when
  camera software is disabled, producing all-zeros on the I2S data line.
